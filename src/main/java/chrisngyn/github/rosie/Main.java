...
public class Main {
    public static void main(String[] args) {
        ...
        // Run --> Main --> CommandsHandler --> call constructors of classes --> put objects into map --> look up and execute when prompted
        try {
            FileReader reader = new FileReader("./credentials/discordtoken.txt");
